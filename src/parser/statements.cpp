...
RepeatStatement::RepeatStatement(const std::shared_ptr<Expression> &condition, const std::shared_ptr<BlockStatement> &body, const Position &start, const Position &end) : condition(condition), body(body), Statement(StatementType::Repeat, start, end) {}
